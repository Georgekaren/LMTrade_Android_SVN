...
public class RestaurantShoppingCarActivity extends RestaurantBaseActivity  implements OnItemButtonListener, OnItemLongClickListener {
	...
	protected void processLogic() {
		...
		getDataFromServer(requestVo, new DataCallback<Cart>() {
			...
			public void processData(Cart paramObject, boolean paramBoolean) {
			    ...
			    mAdapter = new ShoppingCarAdapter(RestaurantShoppingCarActivity.this, paramObject);
		...
		case R.id.shopcar_item_delete_text:// 删除
			...
			if (bool != null) {
				if (bool) {
					...
					Toast.makeText(RestaurantShoppingCarActivity.this, R.string.delete_success, Toast.LENGTH_LONG).show();
				}
			}

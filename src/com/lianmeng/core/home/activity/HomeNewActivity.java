...
public class HomeNewActivity extends BaseWapperNewActivity implements OnItemClickListener, OnItemSelectedListener ,View.OnClickListener{
	...
	protected void processLogic() {
		...
		getDataFromServer(reqVo, new DataCallback<List<HomeBannerVo>>() {
			...
			public void processData(List<HomeBannerVo> paramObject, boolean paramBoolean) {
				HomeBannerAdapter adapter = new HomeBannerAdapter(HomeNewActivity.this, paramObject);

...
import com.lianmeng.core.home.activity.MyHomeListView.OnRefreshListener;
...
public class RefreshScrollView extends ScrollView {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			lastY = (int) ev.getY();
			Logger.d("refresh","getScrollY:" + getScrollY());
			if (getScrollY() == 0
		...
		default:
			...
			Logger.d("refresh","ev.getAction: " +ev.getAction());
			if (getScrollY() == 0) {
				Logger.d("refresh","topMargin():" + headerView.getTopMargin());
				...
				Logger.d("refresh","resetHeaderView...");
				resetHeaderView();
			}
			break;
		}
	...
	public void resetHeaderView() {
		...
		Logger.d("refresh","margin: " + margin);
		Logger.d("refresh","finalMargin: " + finalMargin);
	...
	public void startRefresh() {
		...
		headerView.setState(ScrollViewHeader.STATE_REFRESHING);
		if(listener != null) {
			Logger.d("refresh","xxx: " + headerHeight);
	...
	public void computeScroll() {
		if(scroller!=null&&scroller.computeScrollOffset()) {
			Logger.d("refresh","getCurrY: " + scroller.getCurrY()); 

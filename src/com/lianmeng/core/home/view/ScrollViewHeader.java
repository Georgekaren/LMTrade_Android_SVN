...
public class ScrollViewHeader extends LinearLayout implements OnTouchListener  {
	...
	public void initView(Context context) {
		...
		View view = LayoutInflater.from(context).inflate(R.layout.act_home_view_scrollview_header, this, true);

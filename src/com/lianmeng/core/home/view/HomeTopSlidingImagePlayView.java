...
import com.lianmeng.core.home.adapter.HomeTopImageViewPagerAdapter;
...
/**
 * 名称：AbPlayView 描述：首页最上面可播放显示的View.
 * 
 * @author tans
 * @date 2014-09-26
 * @version
...
public class HomeTopSlidingImagePlayView extends LinearLayout {
	...
	private HomeTopImageViewPagerAdapter mAbViewPagerAdapter = null;
	 ...
	 * @param context
	 */
	public HomeTopSlidingImagePlayView(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 *            the attrs
	 */
	public HomeTopSlidingImagePlayView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	public void initView(Context context) {
		...
		mAbViewPagerAdapter = new HomeTopImageViewPagerAdapter(context, mListViews);

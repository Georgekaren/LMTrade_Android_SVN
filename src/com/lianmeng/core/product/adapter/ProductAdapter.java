...
public class ProductAdapter extends ImageAsyncLoaderAdpter<ProductListVo> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tvPrice.setText(getContext().getString(R.string.prodListTitleProdMenberPriceMsg) + item.getPrice() + "");
		holder.tvMkPrice.setText(getContext().getString(R.string.prodListTitleProdPriceMsg) + item.getMarketprice() + "");

...
public class HHttp {
	...
	public String doPost(String url, Map<String, String> params) throws Exception{
		...
		try {
			// 添加请求参数到请求对象
			if (params != null)
				//new UrlEncodedFormEntity(new HashMap(), HTTP.UTF_8);
				post.setEntity(new StringEntity(params.get("JsonData").toString()));
				// 发起请求
...
//	
	...
	public String doPostSringEitity(String url, Map<String, String> params) throws Exception{
		// POST参数组装
		List<NameValuePair> data = new ArrayList<NameValuePair>();
		if (params != null) {
			Iterator<Entry<String, String>> iter = params.entrySet().iterator();

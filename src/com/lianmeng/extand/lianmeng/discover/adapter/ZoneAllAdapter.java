...
import com.lianmeng.extand.lianmeng.discover.common.SquareImageView;
...
import com.lianmeng.extand.lianmeng.discover.utils.Utils;
...
public class ZoneAllAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null) {
			convertView=LayoutInflater.from(mContext).inflate(R.layout.adapter_discover_item_topic, null);

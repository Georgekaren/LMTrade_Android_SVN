...
import com.lianmeng.extand.lianmeng.discover.adapter.PostAdapter;
import com.lianmeng.extand.lianmeng.discover.common.CircleImageView;
...
import com.lianmeng.extand.lianmeng.discover.widget.NoScrollListView;
import com.lianmeng.extand.lianmeng.discover.widget.TopBarView;
import com.lianmeng.extand.lianmeng.model.Comment;
...
public class PostInfoActivity extends DisBaseActivity implements IHListViewListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.act_discover_post_info);
	...
	private void addHeadView() {
		View headView=getLayoutInflater().inflate(R.layout.act_discover_post_info_item, null);
	...
	private class ImageAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			// TODO Auto-generated method stub
			convertView=getLayoutInflater().inflate(R.layout.act_discover_post_info_img_item, null);
